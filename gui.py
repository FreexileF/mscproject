...
class editor(Tk):
    ...
    def _create_menu_bar_(self):
        ...
        edit_menu.add_command(label='undo', accelerator='Ctrl+Z', command=lambda: self.handle_menu_action('undo'))
        edit_menu.add_command(label='redo', accelerator='Ctrl+Y', command=self.handle_menu_action('redo'))
        edit_menu.add_separator()
        edit_menu.add_command(label='cut', accelerator='Ctrl+X', command= lambda:self.handle_menu_action('cut'))
